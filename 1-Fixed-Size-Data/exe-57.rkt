...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exe-57) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
    ...
    [(<= -3 x -1)
     (place-image (text (number->string x) 20 "red")
                  ...
                  (place-image ROCKET
                               ...
                               BACKG))]
    [(>= x 0)
     (place-image ROCKET 10 (- ROCKET-CENTER x) BACKG)]))
...
(check-expect
 (show 53)
 (place-image ROCKET 10 (- ROCKET-CENTER 53) BACKG))
...
(define (end? s)
  (if (and (number? s) (>= s HEIGHT)) #true #false))
