...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exe-114-1) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
...
(define (si-main gs)
  (big-bang gs
    ...
    [on-tick si-move 0.2]
    [on-key si-control]
    [check-with check-sigs] ; exercise 114
...
(check-expect (check-sigs (make-sigs (make-posn 1 2) (make-tank 3 4) (make-posn 5 6))) #true)
