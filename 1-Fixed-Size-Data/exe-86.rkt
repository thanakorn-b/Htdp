...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exe-86) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
...
; receive editor and string to render new or old upon it over or not

(check-expect (add? (make-editor "" "") "a") (make-editor "a" ""))
(check-expect (add? (make-editor "asdfasdfasdfasdfasdfasdfasdf" "asdfasdfasdfasdfasdfsadfasdf") "a") (make-editor "asdfasdfasdfasdfasdfasdfasdf" "asdfasdfasdfasdfasdfsadfasdf"))

(define (add? e s)
  (if (> 200 (image-width (beside (text (editor-pre e) 16 "black") (text s 16 "black") (rectangle 1 20 "solid" "red") (text (editor-post e) 16 "black"))))
