...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exe-96) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
...
; first instance
(define i1 (make-aim (make-posn 20 10) (make-tank 28 -3)))

; second instance
(define i2 (make-fired (make-posn 20 10)
            (make-tank 28 -3)
            (make-posn 28 (- HEIGHT TANK-HEIGHT))))

; third instance
(define i3 (make-fired (make-posn 20 100)
            (make-tank 100 3)
            (make-posn 22 103)))
